[Setup]
  ...
  Filename: "{tmp}\instalador-rustdesk.exe"; Parameters: "/S"; Flags: waituntilterminated; StatusMsg: "Instalando RustDesk..."
  Filename: "{sys}\WindowsPowerShell\v1.0\powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -File ""{tmp}\rd-config.ps1"""; Flags: waituntilterminated;
  StatusMsg: "Aplicando configuracion..."